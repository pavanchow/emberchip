...
Every module also carries focused unit tests: scheduler pick, mutex grant order, semaphore conservation and saturation, queue FIFO and fullness, timer wrap, and interrupt dispatch order.
